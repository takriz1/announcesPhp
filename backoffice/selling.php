...
?>         
    <tr>
            ...
            <td class="border px-4 py-2"><?php echo substr($description_s,0,50); ?></td>
            <td class="border px-4 py-2">
            <img src="uploads/selling/<?php echo $libelle_img; ?>" alt="<?php echo $libelle_s; ?>"   style="width:80px;"/>
            </td>
            ...
            <td class="border px-4 py-2">
                ...
                <a class="bg-teal-300 cursor-pointer rounded p-1 mx-1 text-white" href="modifier-selling.php?id=<?php echo $id_s; ?>">
