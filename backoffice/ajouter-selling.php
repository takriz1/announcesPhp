...
$query = "INSERT INTO `selling`( `libelle_s`, `description_s` , `id_cat`, `prix_s`) VALUES ( '$lib','$desc' ,$idcat,$px)";
//echo $query;
...
$countfiles = count($_FILES['image']['name']);	
 for($i=0;$i<$countfiles;$i++){
		...
		try {
      // 3- Préaparation de la requete
$query_img = "INSERT INTO `images_selling`( `libelle_img`, `id_s`) VALUES ( '$name','$last_id')";
        ...
        <div class="flex flex-1">
            ...
            <main class="bg-white-500 flex-1 p-3 overflow-hidden">
                ...
                <div class="flex flex-col">
                    ...
                    <input class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" id="cus_name" name="px" type="number" required="" placeholder="Prix" aria-label="Name">
                </div>
