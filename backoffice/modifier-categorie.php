...
$query = "SELECT * FROM `categories` where id_c=$id ";
...
$idcat = addslashes($_POST['idcat']);
	...
	$query_up = "UPDATE `categories` SET `libelle_c`='$lib',`description_c`='$desc',`image_c`='$name',`id_parent`='$idcat' WHERE id_c=$id ";
		...
		$query_up = "UPDATE `categories`  SET `libelle_c`='$lib',`description_c`='$desc' , `id_parent`='$idcat' WHERE id_c=$id ";
	}
        ...
        <div class="flex flex-1">
            ...
            <main class="bg-white-500 flex-1 p-3 overflow-hidden">
                ...
                <div class="flex flex-col">
                    ...
                    <input class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" id="cus_name" name="lib" type="text" required="" placeholder="Libellé" aria-label="Name" value="<?php echo $libelle_c; ?>">
                </div>
                <div class="mt-2">
                    ...
                    <textarea class="w-full px-5  py-4 text-gray-700 bg-gray-200 rounded" id="cus_email" name="desc" type="text" required="" placeholder="Description" aria-label="Email">
                        <?php echo $description_c; ?>
                          ...
                          <input required type="file" class="form-control" id="basic-default-fullname"  name="image" />
                                    ...
                                    <p> <img src="uploads/<?php echo $image_c; ?>" alt="<?php echo $libelle_c; ?>"   style="width:50px;"/></p>
