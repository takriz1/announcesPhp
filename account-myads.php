...
<li><i class="lni-envelope"></i> <a href="http://preview.uideck.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="aedddbdedec1dcdaeec9c3cfc7c280cdc1c3">[email&#160;protected]</a></li>
</ul>
...
<a class="nav-link dropdown-toggle" href="index.php" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
Home
</a>
...
<a class="dropdown-item" href="post-ads.php">Ads Post</a>
...
<h4><?php echo $_SESSION['telephone']; ?></h4>
<h4>Annonceur</h4>
</div>
</div>
...
<td class="photo"><img class="img-fluid" src="tailwind/uploads/produits/<?php echo $libelle_img; ?>" alt="<?php echo $libelle_p; ?>" /></td>
<td data-title="Title">
<h3><?php echo $libelle_p; ?></h3>

</td>
<td data-title="Category"><span class="adcategories"><?php echo $libelle_c; ?></span></td>
<td data-title="Ad Status"><span class="adstatus adstatusactive">active</span></td>
<td data-title="Price">
<h3><?php echo $prix_p; ?></h3>
</td>
