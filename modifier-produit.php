                                ...
                                <div class="dashboard-wrapper">
                                    <form action="" method="POST" enctype="multipart/form-data">
                                        <div class="form-group mb-3">
                                            ...
                                            <input class="form-control input-md" name="lib" placeholder="Title"
                                                type="text" value="<?php echo $libelle_p; ?>">
                                        </div>
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input class="form-control input-md" name="price"
                                                placeholder="Ad your Price" type="text" value="<?php echo $prix_p; ?>">
                                        </div>
