...
<div class="contents">
<h1 class="head-title">Welcome to The Largest <span class="year">Sports Based Marketplace</span></h1>
...
<option value="none">Sousse</option>
<option value="none">Tunisia</option>
<option value="none">Sfax</option>
<option value="none">Nebil</option>
<option value="none">Gasrine</option>
<option value="none">Monastir</option>
</select>
</div>
...
<option value="none">Gym</option>
<option value="none">Swim</option>
<option value="none">Hiking</option>
<option value="none">Camping</option>
<option value="none">Clothes</option>
<option value="none">Tennis</option>
...
<div class="item">
<a href="categoryProduct.php?idcategory=13">
...
<h4>Camping Gear</h4>
    ...
    <div class="item">
<a href="categoryProduct.php?idcategory=15">
<div class="category-icon-item">
<div class="icon-box">
<div class="icon">
...
<h4>Tennis Gear</h4>
    ...
    <div class="item">
<a href="categoryProduct.php?idcategory=10">
<div class="category-icon-item">
<div class="icon-box">
<div class="icon">
...
<div class="item">
<a href="categoryProduct.php?idcategory=17">
<div class="category-icon-item">
<div class="icon-box">
<div class="icon">
...
<div class="icon-box">
<div class="icon">
<img src="assets/img/category/img-7.png" alt="">
</div>
<h4>Outdoor Gear</h4>
</div>
</div>
...
<div class="icon-box">
<div class="icon">
<img src="assets/img/category/img-8.png" alt="">
</div>
<h4>Clothes</h4>
</div>
</div>
...
<h3>
<a href="single-post.html">Media Formation</a>
</h3>
<p>
...
<h3>
<a href="single-post.html">LeSportif</a>
</h3>
<p>
Reprehenderit nemo quod tempore doloribus ratione distinctio quis quidem vitae sunt reiciendis, molestias omnis soluta.
</p>
<a href="single-post1.html" class="btn btn-common">Read More</a>
</div>
</div>
...
<h3>
<a href="single-post2.html">Decathlon</a>
</h3>
<p>
Reprehenderit nemo quod tempore doloribus ratione distinctio quis quidem vitae sunt reiciendis, molestias omnis soluta.
</p>
<a href="single-post2.html" class="btn btn-common">Read More</a>
</div>
</div>
...
<div class="row wow fadeInLeft" data-wow-delay="0.2s">
    ...
    while ($array = mysqli_fetch_array($exec)) {
        ...
        <a href="#"><img src="tailwind/uploads/produits/<?php echo $libelle_img; ?>" alt="<?php echo $libelle_p; ?>"   style="width:140px;"/></a>
        </figure>
        ...
        <span>
        <a href="#"><i class="lni-tag"></i><?php echo $libelle_p; ?></a>
        </span>
        </div>
        <p class="dsc"><?php echo $description_p; ?></p>
        <div class="listing-bottom">
        <h3 class="price float-left"><?php echo $prix_p; ?> TND</h3>
...
<div id="new-products" class="owl-carousel owl-theme">
     ...
     while ($array = mysqli_fetch_array($exec)) {
         ...
         // Préaparation de la requete categories
         $query_cate = "SELECT * FROM `categories` where id_c=$id_cat ";
         //  Exécution de la requete cat
         $exec_cate = mysqli_query($conn, $query_cate);

         while ($array = mysqli_fetch_array($exec_cate)) {

             $libelle_c = $array['libelle_c'];

         }

         $query_img = "SELECT * FROM `images_selling` where id_s=$id_s ";
         $exec_img = mysqli_query($conn, $query_img);
         $array_img = mysqli_fetch_array($exec_img);
         $libelle_img = $array_img['libelle_img'];
        ...
        <a href="#"><img src="tailwind/uploads/selling/<?php echo $libelle_img; ?>" alt="<?php echo $libelle_p; ?>"   style="width:140px;"/></a>
        <div class="overlay">
        <div>
        ...
        <span class="price"><?php echo $prix_s; ?> TND</span>
        </div>
        <div class="product-content">
        <h3 class="product-title"><a href="ads-details.html"><?php echo $libelle_s; ?></a></h3>
        <span><?php echo $libelle_c; ?> / <?php echo $libelle_s; ?></span>
        <div class="icon">
        <span><i class="lni-bookmark"></i></span>
...
<div class="widget">
<div class="footer-logo"><img src="assets/img/logo1.png" alt=""></div>
...
<li>
<strong><i class="lni-phone"></i></strong><span>+216 99 903 321 </span>
</li>
<li>
...
<li>
<strong><i class="lni-map-marker"></i></strong><span><a href="#">Cité echabeb, Sousse <br>Tunisie</a></span>
</li>
</ul>
</div>
</div>
